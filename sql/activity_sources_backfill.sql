...
--
-- Note: garmin_activities stores the sport value in the `sport` column (not `sport_type`).
-- The backfill maps ga.sport -> activity_sources.sport_type to match the target schema.
--
